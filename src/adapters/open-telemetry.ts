...
export class OpenTelemetry implements Adapter {
    ...
    constructor(endpoint: string, serviceNamespace: string, serviceName: string, serviceInstanceId: string) {
        this.initMeter(endpoint, serviceNamespace, serviceName, serviceInstanceId);
    }

    private initMeter(endpoint: string, serviceNamespace: string, serviceName: string, serviceInstanceId: string): void {
    ...
    createCounter(name: string, unit?: string, description?: string, _advisory: any[] = []): Counter {
    ...
    createHistogram(name: string, unit?: string, description?: string, _advisory: any[] = []): Histogram {
    ...
    createGauge(name: string, unit?: string, description?: string, _advisory: any[] = []): Gauge {
    ...
    createUpDownCounter(name: string, unit?: string, description?: string, _advisory: any[] = []): UpDownCounter {
